# Historical Bowling validation — 2026-09-10
...
Current transport validation uses WebRTC. See ../LAN_CONTROLLER_MODE.md and the separate signaling repository's TURN_SETUP.md.
